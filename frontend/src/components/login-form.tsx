...
export function LoginForm({
  ...
  return (
    <div className="flex min-h-dvh w-full flex-col lg:flex-row">
      ...
      <section className="flex flex-1 flex-col items-center bg-background px-4 pb-6 lg:w-1/2 lg:min-h-dvh lg:px-12 lg:py-10">
        <div className="flex w-full max-w-md flex-1 flex-col justify-center pb-4">
          <div
            className={cn(
              'w-full space-y-5 rounded-2xl border border-border bg-card p-6 shadow-sm sm:p-8',
        ...
        <p className="w-full max-w-md shrink-0 text-center text-sm text-muted-foreground">
          Powered by Automação Pedertractor
        </p>
      </section>
    </div>
  );
