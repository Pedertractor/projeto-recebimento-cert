...
export function SolicitacaoComprasDetailPage() {
  ...
  const canAttachCertificate = request.status === 'AGUARDANDO_FORNECEDOR';
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Certificados anexados: {attachedCount} de {request.expectedCertificates}{' '}
              lote{request.expectedCertificates === 1 ? '' : 's'}
              {canCompleteRequest
